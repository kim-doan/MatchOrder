...
public class DeliveryCostInfo {
	...
	public DeliveryCostInfo(int form_id, String form_name, String seller_def_yn, String delivery_cost_type,
			String bundle_delivery_yn, Integer add_cost_jeju, Integer add_cost_mount, Integer cost_free_price,
			Integer cost_free_num_repeat, Integer cost_free_num, Date create_at, Date modify_at, Integer used) {
		super();
